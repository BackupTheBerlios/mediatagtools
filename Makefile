#############################################################################
# Makefile for building: mediatagtools
# Generated by qmake (1.07a) (Qt 3.3.4) on: Sat Oct 15 16:53:01 2005
# Project:  mediatagtools.pro
# Template: subdirs
# Command: $(QMAKE) -o Makefile mediatagtools.pro
#############################################################################
...
Makefile: mediatagtools.pro  /usr/qt/3/mkspecs/linux-g++/qmake.conf 
	$(QMAKE) -o Makefile mediatagtools.pro
qmake: qmake_all
	@$(QMAKE) -o Makefile mediatagtools.pro
